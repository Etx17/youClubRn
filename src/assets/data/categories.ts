...
const categories: Category[] = [
  ...
  // { label: "👪 Services familiaux, services aux personnes âgées", value: "Services familiaux, services aux personnes âgées" },
  { label: "🗳️ Activités politiques", value: "activités politiques" },
  { label: "💭 Clubs, cercles de réflexion", value: "clubs, cercles de réflexion" },
  // { label: "🎣 Chasse pêche", value: "Chasse pêche" },
  // { label: "🏥 Services et établissements médico-sociaux", value: "Services et établissements médico-sociaux" },
  // { label: "🏠 Logement", value: "Logement" },
  { label: "🔬 Recherche", value: "recherche" },
  // { label: "🎖️ Armée (dont préparation militaire, médailles)", value: "Armée (dont préparation militaire, médailles)" },
  // { label: "🌍 Tourisme", value: "Tourisme" },
  // { label: "🚨 Sécurité, protection civile", value: "Sécurité, protection civile" },
